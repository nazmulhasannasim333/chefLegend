  ...
  return (
    <section className=" py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className='grid gap-8 mb-8 lg:grid-cols-12 sm:grid-cols-1'>
          <div className="mt-20 lg:col-span-7 sm:col-span-1">
        ...
        <div className="mt-10 flex justify-center">
          ...
          <div className="my-5 mt-10 px-2 lg:col-span-5 sm:col-span-1">
